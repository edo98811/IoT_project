...
class catalog():
    ...
    def GET(self,*uri,**params): # come funzionano questi parametri?
        ...
        if uri[0] == 'get_dc_info':
            ...
            # }
            return json.dumps(pat['device_connector'])
        ...
        #sensori elativi ad un paziente
            ...
            for sensor_id in sensor_ids:
                   ...
                   sensor_list.append(next((s for s in catalog['sensors'] if s['sensor_ID'] == sensor_id ), None))
        ...
        #per il dottore di un paziente
            ...
            # questa funzione crea un iterator della lista (un oggetto che applica una funzione a qualche altro oggetto, in questo caso applica un controllo ad una lista)

            return json.dumps(doctor) # se serve un campo in particolare
